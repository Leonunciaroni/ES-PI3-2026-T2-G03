...
enum _ChipFilter { todas, novas, emOperacao, emExpansao }
...
class _CatalogScreenState extends State<CatalogScreen> {
  ...
  List<CatalogStartup> get _visibleStartups {
    return _allStartups
        .where((s) => _matchesChip(s) && _matchesSearch(s))
        .toList();
  }
                        ...
                        ..._visibleStartups.map(
                          (s) => Padding(
                            ...
                            child: _CatalogStartupCard(
                              startup: s,
                              tokenPriceFormatted: _formatTokenPrice(
                                s.tokenPrice,
                              ),
                              ...
                              onOpenDetail: () {
                                ...
                                Navigator.of(context).push<void>(
                                  MaterialPageRoute<void>(
                                    builder: (ctx) =>
                                        StartupDetailScreen(data: detail),
                                  ),
                                );
                              },
                            ),
...
class _CatalogStartupCard extends StatelessWidget {
  ...
  /// Abre a [StartupDetailScreen] com dados mock resolvidos por [startupDetailFor].
